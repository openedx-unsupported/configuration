...
FEATURES['ENABLE_ACCOUNT_DELETION'] = True
...
LTI_CREDENTIALS = BDU_ENV_TOKENS.get('LTI_CREDENTIALS', {})

CUSTOM_CERT_ISSUER = BDU_ENV_TOKENS.get('CUSTOM_CERT_ISSUER', PLATFORM_NAME)
