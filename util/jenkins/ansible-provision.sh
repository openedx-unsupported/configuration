...
MCKINSEY_APROS_MYSQL_PASSWORD: "{{ EDXAPP_MYSQL_CSMH_PASSWORD }}"
MCKINSEY_APROS_MYSQL_USER: "{{ EDXAPP_MYSQL_CSMH_USER }}"
db_root_user: "{{ EDXAPP_MYSQL_CSMH_USER }}"
DBPassword: "{{ EDXAPP_MYSQL_CSMH_PASSWORD }}"
