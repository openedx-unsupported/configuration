...
run_ansible -i "${deploy_host}," $WORKSPACE/configuration/playbooks/edx-east/create_db_and_users.yml $extra_var_arg -e  "ansible_python_interpreter=/usr/bin/env python" --user ubuntu
