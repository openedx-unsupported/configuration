...
class TestCheckCeleryQueues(unittest.TestCase):
    ...
    def test_should_send_alert(self):
        current_time = self.time_0
        first_occurance_time = current_time - timedelta(minutes=6)
        threshold = 5 * 60
        result = should_send_alert(first_occurance_time, current_time, threshold)
        self.assertEqual(True, result)

        first_occurance_time = current_time - timedelta(minutes=4)
        result = should_send_alert(first_occurance_time, current_time, threshold)
