...
##
cd /var/tmp
git clone https://github.com/hetmantsev-openedx/configuration
cd configuration
...
##
cd /var/tmp/configuration/playbooks && sudo -E ansible-playbook -c local ./small_deployments/edx-stateless.yml -i "localhost," $EXTRA_VARS
